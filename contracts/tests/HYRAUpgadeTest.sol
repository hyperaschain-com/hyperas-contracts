...
/**
 * @title HYRAUpgrade as native coin in layer 3 chain
 * @dev This contract is used to test the upgradeable contract
 */
contract HYRAUpgrade is ERC20Upgradeable, ERC20BurnableUpgradeable, AccessControlUpgradeable{
    ...
    */
    ...
    /**
     * @dev Function to test the upgradeable contract
    */
