...
/**
 * @title HYRA upgradable test contract
 * @dev This contract is used to mint HYRA to pools
 */
contract HYRAUpgadeTest is ERC20Upgradeable, ERC20BurnableUpgradeable, AccessControlUpgradeable, UUPSUpgradeableCustom {
